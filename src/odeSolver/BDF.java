...
public class BDF extends LinearMultistep {

	/**
	 * BFD Method - Implicit - Order s
	 * @param diff Differential Equation To Solve
	 * @param s Method Stage Number, from 1 to 6
	 * @throws WrongInputException
	 */
	public BDF (DifferentialEquation diff, int s) throws WrongInputException {
	 ...
	 * @throws WrongInputException
	 */
	public BDF (DifferentialEquation diff) throws WrongInputException {
